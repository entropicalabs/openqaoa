...
class Gate(ABC):
    ...
    def __init__(self, ibm_gate, vector_gate):
...
class RY(OneQubitGate):
    ...
    def __init__(self):
        ...
        super().__init__(ibm_gate=ibm_gate, vector_gate=vector_gate)
...
class RXX(TwoQubitGateWithAngle):
    ...
    def __init__(self):
        ...
        super(TwoQubitGate,self).__init__(ibm_gate=ibm_gate, vector_gate=vector_gate)
