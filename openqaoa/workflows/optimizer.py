...
class RQAOA(Optimizer):
    ...
    def _exp_val_hamiltonian_termwise(self, q):
        ...
        qaoa_optimized_angles = q.results.optimized['optimized_angles']
        qaoa_optimized_counts = q.results.get_counts(q.results.optimized['optimized_measurement_outcomes'])
