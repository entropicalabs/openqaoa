...
#     def test_set_backend_properties_check_backend_cirq_qasm(self):
#         """
...
#         q = QAOA()
#         q.set_device(create_device(location="local", name="cirq.qasm_simulator"))
...
#         q = QAOA()
#         q.set_device(
#             create_device(location="local", name="cirq.statevector_simulator")
#         )
#         q.compile(problem=qubo_problem)
...
#             location="local", name="cirq.qasm_simulator"
#         )
...
#         qaoas = []
#         for device in [create_device(location="local", name="cirq.shot_simulator")]:
#             q = QAOA()
#             q.set_device(device)
...
#         method="cobyla",
#         maxiter=15,
#         name_device="cirq.statevector_simulator",
#         return_object=False,
#     ):
#         if problem == None:
...
#         rqaoas = []
#         for device in [
#             create_device(location="local", name="cirq.shot_simulator"),
#         ]:
#             r = RQAOA()
#             r.set_device(device)
