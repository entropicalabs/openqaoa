...
#         available_cirq_gates_name = [
#             each_gate.__name__.lower() for each_gate in available_gates
#         ]
#         self.available_cirq_gates = dict(
#             zip(available_cirq_gates_name, available_gates)
#         )
...
#         for each_gate in CirqGateApplicator.CIRQ_OQ_GATE_MAPPER.values():
#             self.assertTrue(
#                 each_gate.__name__.lower() in self.available_cirq_gates.keys(),
#                 "{}, {}".format(each_gate.__name__, self.available_cirq_gates.keys()),
#             )
...
#             if each_gate not in self.cirq_excluded_gates:
#                 returned_gate = gate_applicator.gate_selector(
#                     each_gate(applicator=None, qubit_1=None)
#                 )
#                 self.assertEqual(
#                     self.available_cirq_gates[returned_gate.__name__.lower()],
#                     returned_gate,
#                 )
...
#                 ],
#                 [
#                     gate_applicator.CIRQ_OQ_GATE_MAPPER[
#                         each_gate.__name__
#                     ].__name__.lower()[:-4]
#                 ],
#             )
