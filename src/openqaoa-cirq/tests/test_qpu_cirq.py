...
#         cirq_backend = QAOACirqQPUBackend(
#             qaoa_descriptor, cirq_device, shots, None, None, True
#         )
#         qpu_circuit = cirq_backend.qaoa_circuit(variate_params)
...
#         cirq_backend = QAOACirqQPUBackend(
#             qaoa_descriptor, cirq_device, shots, prepend_circuit, None, True
#         )
#         qpu_circuit = cirq_backend.qaoa_circuit(variate_params)
...
#         cirq_backend = QAOACirqQPUBackend(
#             qaoa_descriptor, cirq_device, shots, None, append_circuit, True
#         )
#         qpu_circuit = cirq_backend.qaoa_circuit(variate_params)
...
#             )
#             cirq_statevec_expectation = cirq_statevec_backend.expectation(
#                 variate_params
#             )

#             acceptable_delta = 0.05 * cirq_statevec_expectation
#             self.assertAlmostEqual(
#                 cirq_expectation, cirq_statevec_expectation, delta=acceptable_delta
#             )
...
#         cirq_device = DeviceCirq("ibm_kyoto", self.HUB, self.GROUP, self.PROJECT)
...
#         self.assertEqual(type(cirq_expectation.item()), float)
...
#         job = cirq_backend.device.backend_device.run(
#             circuit, shots=cirq_backend.n_shots
#         )
