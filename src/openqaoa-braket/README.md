...
A multi-backend python library for quantum optimization using QAOA on Quantum computers and Quantum computer simulators. This package is a plug-in extension that contains the code required to run OpenQAOA with the braket SDK for AWS's Braket Service.
