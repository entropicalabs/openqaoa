...
class TestingUtilities(unittest.TestCase):
    ...
    def test_exp_val_hamiltonian_termwise(self):
        ...
        qaoa_optimized_angles = qaoa_results_optimized['optimized_angles']
        qaoa_optimized_counts = qaoa_results.get_counts(qaoa_results_optimized['optimized_measurement_outcomes'])
